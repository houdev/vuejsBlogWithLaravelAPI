    ...
    <v-container>
        <v-row justify="center" align="center">
          <v-card width="85%">
            ...
            <v-list-item >
              <v-list-item-content>
                <div class="overline mb-4">{{ myArticles[currentIndex].createdDate }}</div>
                <v-list-item-title class="headline mb-1">
                  {{ myArticles[currentIndex].title }}
                </v-list-item-title>
                <v-spacer></v-spacer>
                <v-divider class="mx-4"></v-divider>
                <v-spacer></v-spacer>
                <v-list-item-text>{{ myArticles[currentIndex].body }}</v-list-item-text>
              </v-list-item-content>
            </v-list-item>
